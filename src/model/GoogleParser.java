...
public class GoogleParser {
	...
	public GoogleParser(String googleUrl) {
	...
	private URL encodeGoogleQuery(final String[] args, int pagina) {
		...
		try {
			...
			return new URL("http", googleUrl, localAddress.toString());
